...
(use-package org
  ...
  :custom
  (org-persist-directory (expand-file-name "org/persist/" nn-directory))
  (org-id-locations-file (expand-file-name "org/id-locations.el" nn-directory))
  (org-publish-timestamp-directory (expand-file-name "org/timestamps/" nn-directory))
  (org-modules nil)
  ...
  (dolist (abbrev '(("github"     . "https://github.com/%s")
                    ...
                    ("emacsdir"   . ,(expand-file-name "%s" user-emacs-directory))))
