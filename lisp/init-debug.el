...
(use-package dape
  ...
  ("C-<f5>"  . dape-kill)
  :custom
  (dape-adapter-dir (expand-file-name "dape/adapters/" nn-directory))
  (dape-default-breakpoints-file (expand-file-name "dape/breakpoints.eld" nn-directory))
  (dape-inlay-hints nil)
  (dape-buffer-window-arrangement 'right)
  :config
  (make-directory (expand-file-name "dape/adapters/" nn-directory) t)
