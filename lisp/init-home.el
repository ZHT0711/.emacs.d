...
(defconst nn-home-package-load-cout (length package-activated-list))
...
(defun nn-home-insert-info ()
  (let* ((text (format "%d packages loaded in %s" nn-home-package-load-cout nn-home-emacs-init-time))
